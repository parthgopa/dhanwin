...
export const walletAPI = {
  ...
  getCryptoDepositConfig: () => apiCall('/wallet/deposit/crypto/config', 'GET'),
  getMyCryptoDepositAddress: () => apiCall('/wallet/deposit/crypto/my-address', 'GET'),
  verifyCryptoDeposit: (data) => apiCall('/wallet/deposit/crypto/verify-tx', 'POST', data),
  checkIncomingCryptoDeposit: (chain) =>
    apiCall(`/wallet/deposit/crypto/check-incoming${chain ? `?chain=${encodeURIComponent(chain)}` : ''}`, 'GET'),
